    ...
    <Modal show={show} onHide={onClose} size="xl">
      ...
      <Modal.Body className='newspaper-modal-body'>
        <div className="newspaper-container custom-width">
          ...
          <p className='paragraph-text'>
            If anyone has any information on Dez Giant or her whereabouts, please contact the DevTown PD at (503) 333 - 2854. Ms Giant is the sixth young woman to have gone missing in these woods in the past 10 years.
          </p>
          <br />
