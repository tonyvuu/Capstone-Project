...
const characters = [
  {
    ...
    answer: "The twins came home unannounced around 7pm and share their plans of taking break from college. It upsets me because 26 year olds shouldn't be home. Because of that, we got into a huge argument and twins decided not to deal with the conversation and left to the cabin house.",
    question2: 'Where did you go last night?',
    answer2:"Went to the drugstore around 8pm to pick up prescription (antidepressant & insomnia). After I came home, Ellen and I went to bed around 10pm. I am almost sure was home all night.",
    question3: "Did you tell anyone where the twins are?",
    answer3:'I actually bump into Jen Doe at the drugstore but she was acting a bit unusual.. She was tightly clutching a brown paper bag',
  ...
  },
  {
    ...
    answer2:"My work doesn't require me entering the house but what do you mean noticable? Did the house get robbed or something? Any idiot would find that hidden key underneath the doormat.",
    question3: 'Where were you last night?',
    answer3:'Finished my job @ 9pm and drove around the area to scout for some potential work.',
    ...
    answer6:"A white van. I got a bunch of tools in there like trimmers, rakes, shovels, and etc.",
  ...
  },
  {
    ...
    question6:"Why did we find a picture with a drawn-in evil smile on your face?",
  ...
  },
  {
    ...
    answer: 'They came home unexpectedly from college last night and announce plans to take a year break which led to an argument with the parents. Twins left house at 7:30pm to beach house and no contact until police called @ 5am.',
  ...
  },
  {
    ...
    answer2:'Flipping a house but I need one of them to cosign a loan. Probably the easiest 65k. I did get a hold of McKenna @ 9pm but she brushed me off on the home-flipping deal. She immediately hung up after I told her it could pay up to a year off of her college tuition.',
  ...
  },
  {
    ...
    question4: 'Are you a patient at MPH?',
    answer4:'Yes, I was released from there because I had some issues with some hikers. Them doctors say I am diagonesed with bipolar disorder.',
