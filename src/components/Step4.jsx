...
const Step4 = () => {
  ...
  return (
    <div>
      ...
      {showForm && (
        <AnswerComponent
          placeholder="Hmm.. who does that hospital ID belongs too.."
